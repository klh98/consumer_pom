...
public class EAPlayProPage {

    AndroidDriver driver;

    public EAPlayProPage(AndroidDriver driver)
    {
        this.driver = driver;
    }
    ...
    private final By EAPlayPro = AppiumBy.accessibilityId("biller");
    ...
    public void clickEAPlayPro() {
        WebDriverWait wait = new WebDriverWait(BaseTest.getDriver(), Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(EAPlayPro)).click();
    }
    ...
    public void selectProduct() {
        ...
        By product = AppiumBy.androidUIAutomator(
                "new UiScrollable(new UiSelector().scrollable(true))" +
                        ".scrollIntoView(new UiSelector().textContains(\"15 Unit\"))"
        );
