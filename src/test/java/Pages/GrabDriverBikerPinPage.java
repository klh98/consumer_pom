...
public class GrabDriverBikerPinPage {

    AndroidDriver driver;

    public GrabDriverBikerPinPage(AndroidDriver driver)
    {
        this.driver = driver;
    }
    ...
    private final By iTunes = AppiumBy.accessibilityId("biller");
    ...
    public void click_GrabDriverBikerPin() {
        WebDriverWait wait = new WebDriverWait(BaseTest.getDriver(), Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(iTunes)).click();
    }
    ...
    public void selectProduct() {
        ...
        By product = AppiumBy.androidUIAutomator(
                "new UiScrollable(new UiSelector().scrollable(true))" +
                        ".scrollIntoView(new UiSelector().textContains(\"10000\"))"
        );
